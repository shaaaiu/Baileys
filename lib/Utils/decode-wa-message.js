...
function decodeMessageNode(stanza, meId, meLid) {
    ...
    let participant = stanza.attrs.participant_pn || stanza.attrs.participant;
    ...
    let fromMe = (0, WABinary_1.isJidNewsletter)(from) ? !!((_d = stanza.attrs) === null || _d === void 0 ? void 0 : _d.is_sender) || false : ((0, WABinary_1.isLidUser)(from) ? isMeLid : isMe)(stanza.attrs.participant || stanza.attrs.from);
    if (isMeLid(participant)) {
        fromMe = true;
        participant = meLid;
    }
